...
//        action = new Actions(WebDriverFactory.getDriver());
    ...
    public static void assertTextByLocator(String elementText,String expectedText)
    {
        Assert.assertEquals(elementText,expectedText);
    }

    public static void assertValueByLocator(String elementVal,String expectedVal)
    {
        Assert.assertEquals(elementVal,expectedVal);
    }
